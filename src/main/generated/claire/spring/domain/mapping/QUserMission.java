...
public class QUserMission extends EntityPathBase<UserMission> {
    ...
    private static final long serialVersionUID = -419491026L;
    ...
    public final claire.spring.domain.QMission mission;

    public final EnumPath<claire.spring.domain.enums.MissionStatus> status = createEnum("status", claire.spring.domain.enums.MissionStatus.class);
    ...
    public QUserMission(Class<? extends UserMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new claire.spring.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
