...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 690429880L;
    ...
    public final com.umc.domain.QMember member;

    public final com.umc.domain.QMission mission;

    public final EnumPath<com.umc.domain.enums.MissionStatus> status = createEnum("status", com.umc.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.umc.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.umc.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
